---
title: "Speed Of Straightening (from 5.5m to 1.5m)"
author: "Danlu"
date: "08/09/2019"
...
```{r}
ggplot(offset_seg_trial1, aes(x = seg.z, y = headingErr)) + theme_bw() +
  geom_rect(aes(xmin = starting_point_for_walking, xmax = ending_point_for_walking, ymin = 0, ymax = Inf), fill = "grey50", alpha = 0.3) +
